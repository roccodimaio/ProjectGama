...
AItem::AItem()
{
	...
	CollisionVolume = CreateDefaultSubobject<USphereComponent>(TEXT("SphereComponent"));
...
void AItem::OnOverlapBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	if (OverlapParticles)
	{
		// SpawnEmitterAtLocation requires a Particle System not a Particle System Component
